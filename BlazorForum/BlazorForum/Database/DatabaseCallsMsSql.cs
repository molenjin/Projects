...
{
    public class DatabaseCallsMsSql : IDatabaseCalls
    {
        private readonly SqlConnection Connection;

        public DatabaseCallsMsSql(IConfiguration configuration)
        {
        ...
        {
            var param = new { ShowAll = showAll, PageLimit = pageLimit, PageOffset = (pageNo - 1) * pageLimit };
